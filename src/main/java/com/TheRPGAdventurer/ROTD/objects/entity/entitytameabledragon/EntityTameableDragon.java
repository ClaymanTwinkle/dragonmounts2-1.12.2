...
import com.TheRPGAdventurer.ROTD.objects.entity.DragonProcessInteractUtils;
...
public class EntityTameableDragon extends EntityTameable implements IShearable, PrivateAccessor {
    ...
    public EntityTameableDragon(World world) {
        ...
        addHelper(new DragonControlHelper(this));
...
//        }
    ...
    public boolean boosting() {
        return getControlHelper().boosting();
    }

    public void setBoosting(boolean allow) {
        getControlHelper().setBoosting(allow);
    }
    ...
    public boolean isMale() {
        return getBreedHelper().isMale();
    }

    public void setMale(boolean male) {
        getBreedHelper().setMale(male);
    }
    ...
    public boolean isFlying() {
        return getControlHelper().isFlying();
    }
    ...
    public void setFlying(boolean flying) {
        getControlHelper().setFlying(flying);
    }
    ...
    public boolean isGoingDown() {
        return getControlHelper().isGoingDown();
    }
    ...
    public boolean allowedOtherPlayers() {
        return getInventoryHelper().allowedOtherPlayers();
    }

    public void setToAllowedOtherPlayers(boolean allow) {
        getInventoryHelper().setToAllowedOtherPlayers(allow);
    }

    public boolean isYLocked() {
        return getControlHelper().isYLocked();
    }

    public void setYLocked(boolean yLocked) {
        getControlHelper().setYLocked(yLocked);
    }

    public boolean isUnHovered() {
        return getControlHelper().isUnHovered();
    }

    public void setUnHovered(boolean isUnhovered) {
        getControlHelper().setUnHovered(isUnhovered);
    }

    public boolean followYaw() {
        return getControlHelper().followYaw();
    }

    public void setFollowYaw(boolean folowYaw) {
        getControlHelper().setFollowYaw(folowYaw);
    }
...
//        }
    ...
    public boolean attackEntityAsMob(@Nonnull Entity entityIn) {
        ...
        } else if(getBreedType() == EnumDragonBreed.ZOMBIE) {
            if (entityIn instanceof EntityLivingBase) {
    ...
    public EntityAgeable createChild(@Nonnull EntityAgeable mate) {
        ...
        if (parent1.isMale() && !parent2.isMale() || !parent1.isMale() && parent2.isMale()) {
            return getMateHelper().createChild(parent1.isMale() ? parent2 : parent1);
        } else {
            return null;
        }
    }
    ...
    public DragonControlHelper getControlHelper() {
        return getHelper(DragonControlHelper.class);
    }
    ...
    public List<ItemStack> onSheared(@Nonnull ItemStack item, net.minecraft.world.IBlockAccess world, BlockPos pos, int fortune) {
        ...
        List<ItemStack> ret = new ArrayList<>(i);
        for (int j = 0; j < i; ++j)
            ret.add(new ItemStack(getBreedHelper().getShearItem()));
    ...
    public void eatEvent(Item item) {
    ...
    public boolean processInteract(EntityPlayer player,@Nullable EnumHand hand) {
        return DragonProcessInteractUtils.processInteract(this, player, hand);
    }
}
