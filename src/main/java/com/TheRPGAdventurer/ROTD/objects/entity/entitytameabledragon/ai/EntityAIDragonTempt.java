...
public class EntityAIDragonTempt extends EntityAIBase
{
    ...
    private final EntityTameableDragon temptedEntity;
    ...
    public EntityAIDragonTempt(EntityTameableDragon temptedEntityIn, double speedIn, Item temptItemIn, boolean scaredByPlayerMovementIn)
    {
        this(temptedEntityIn, speedIn, scaredByPlayerMovementIn, Sets.newHashSet(temptItemIn));
    }

    public EntityAIDragonTempt(EntityTameableDragon temptedEntityIn, double speedIn, boolean scaredByPlayerMovementIn, Set<Item> temptItemIn)
    {
    ...
    {
        if(!temptedEntity.isBaby() || !temptedEntity.onGround) {
            return false;
        }
