...
public class LayerRendererDragonBanner extends LayerRendererDragon {
    ...
    @Override
    public void doRenderLayer(@Nonnull EntityTameableDragon dragon, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        ...
        if (itemstack3 != null && itemstack3.getItem() == Items.BANNER) {
        ...
        if (itemstack4 != null && itemstack4.getItem() == Items.BANNER) {
